...
int main()
{
    ...
    int x = 17;
    int index = InterpolationSearch(A, 8, x); // passed array A insid the InterpolationSearsh function
    if (index != -1)
...
// randomly sat x bcoz array was defined by us, therefore not reasonable for asking input.
