 ...
 * using its property (usually monotonic prperty) to find
 * the desired index
 * 
 * Time complexity : 0(log3 n)
 *  Space Complexity :(1) (without the array)
 * */
...
/**
 * The absolutePrecision can be modified to be fit preference but
 * it is recommended to not go lower than 10 due to errors that
 * may accur.
 * 
 * The value of _target shold be decided or can be decided later
 ...
 * You could either use it_ternary_search or rec_ternaary_search according to preference.
 * */
