//This Programme returns the Nith fibonacci as a string.
//The method used is manual addition with carry and placing it in a string which is called sting addition
