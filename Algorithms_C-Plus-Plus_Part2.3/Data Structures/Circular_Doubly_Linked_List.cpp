// Alvaro Henrique
// Data Structure: Circular Linked List (Microchallenge)
#include <stdio.h>
#include <math.h>
#include <string.h>
#include <time.h>
...
int main()
{
    ...
    {
        freopen("/Users/Alvaro/TestLogs/CDLL-Test.txt","w",stdout);
    }
    ...
    printf("Testing carried out on %d-%d-%d, by Alvaro Henrique.", now -> tm_year + 1900, now -> tm_mon + 1, now -> tm_mday);
    printf("\n---------------------------------------------------------------\n");
