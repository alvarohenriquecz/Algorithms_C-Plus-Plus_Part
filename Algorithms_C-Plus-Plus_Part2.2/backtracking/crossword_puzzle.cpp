...
// this function in used to print 
...
// the index of current word n -> represent
// the length of row or colum of the square matrix
...
int main()
{
    ...
    cout << "numbers of ways to fill the grid is "
        << ways << endl;
