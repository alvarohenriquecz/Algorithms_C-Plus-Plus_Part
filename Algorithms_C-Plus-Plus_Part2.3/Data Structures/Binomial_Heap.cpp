...
/*
 Binomial Heap data structute satisfying the heap property, with an efficient merge operation.
 Useful for a priority queue implementation where merges are frequent.
 Complexity:        0(1) for first
                    0(log N) for insert, merge, extractMin, decreaseKey and delete
*/
